...
class RestPanel(project: Project, private var apiPanel: ApiPanel?) : JBPanel<JBPanel<*>>() {
    ...
    private fun createBottomPanel(project: Project): BottomPanel {
        return BottomPanel(project)
    }
    ...
    fun updateApi(url: String, method: String, param: String?) {
